...
<div class="login-box">
  ...
  <div class="login-box-body">
    <h1 class="login-box-msg" style="color:#32CD32;">LOGIN ADMIN</h1><hr/>
    ...
    <!-- /.social-auth-links -->
    <hr/>
    <p><center>Copyright <?php echo '2022'?> by Universitas Sebelas Maret <br/> All Right Reserved</center></p>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
