...
<header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini">LW</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Lembah Wilis</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url().'img_database/pengguna/'.$c['pengguna_photo'];?>" class="user-image" alt="">
              <span class="hidden-xs"><?php echo $c['pengguna_nama'];?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url().'img_database/pengguna/'.$c['pengguna_photo'];?>" class="img-circle" alt="">
